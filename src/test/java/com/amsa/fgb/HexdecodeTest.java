...
public class HexdecodeTest {
    ...
    private static final String DECODE_30_CHRS_HTML_STRING = "<html>" + "<head>"
            ...
            + "<TR><TD>Error Correcting Code</TD><TD>b133-144</TD><TD>000000101101</TD></TR>"
    ...
    private static final String DECODE_30_CHRS_XML2_STRING = "<Line>"
            ...
            + "<Line>"
            + "<Name>Hex Id</Name><Position>b26-85</Position><Value>ADCC40504000185</Value></Line>"
            + "<Line>"
            + "<Name>Country Code</Name><Position>b27-36</Position><Value>366</Value></Line>"
            + "<Line>"
            + "<Name>User Protocol Type</Name><Position>b37-39</Position><Value>Serial</Value></Line>"
            + "<Line>"
            + "<Name>Beacon Type</Name><Position>b40-42</Position><Value>Aviation</Value></Line>"
            + "<Line>"
            + "<Name>C/S cert. no. present</Name><Position>b43</Position><Value>YES</Value></Line>"
            + "<Line>"
            + "<Name>Serial Number</Name><Position>b44-63</Position><Value>5136</Value></Line>"
            + "<Line>"
            + "<Name>National Use</Name><Position>b64-73</Position><Value>0000000000</Value></Line>"
            + "<Line>"
            + "<Name>C/S Type approval number</Name><Position>b74-83</Position><Value>97</Value></Line>"
            + "<Line>"
            + "<Name>Aux. radio-locating</Name><Position>b84-85</Position><Value>121.5 MHz</Value></Line>"
            + "<Line>"
            + "<Name>US Manufacturer ID</Name><Position>b44-51</Position><Value>1</Value></Line>"
            + "<Line>"
            + "<Name>US Sequence No.</Name><Position>b52-63</Position><Value>1040</Value></Line>"
            + "<Line>"
            + "<Name>US Model ID.</Name><Position>b64-67</Position><Value>0</Value></Line>"
            + "<Line>" + "<Name>US Run No.</Name><Position>b68-75</Position><Value>0</Value></Line>"
            + "<Line>"
            ...
            + "<Line>"
            + "<Name>Encoded Position Source</Name><Position>b107</Position><Value>EXTERNAL</Value></Line>"
            + "<Line>"
            + "<Name>Latitude</Name><Position>b108-119</Position><Value>32 44 00N</Value></Line>"
            + "<Line>"
            + "<Name>Longitude</Name><Position>b120-132</Position><Value>117 12 00W</Value></Line>"
            + "<Line>"
            + "<Name>Error Correcting Code</Name><Position>b133-144</Position><Value>000000101101</Value></Line>";
    private static final String DECODE_30_CHRS_XML_STRING = "<?xml version=\"1.0\"?>"
            + "<Hexdecode>"
    ...
    private static final String DECODE_15_CHRS_XML2_STRING = "<Line>"
            ...
            + "<Line>"
            + "<Name>Hex Data</Name><Position>b25-144</Position><Value>Unknown</Value></Line>"
            + "<Line>"
            + "<Name>Hex Id</Name><Position>b26-85</Position><Value>ADCC40504000185</Value></Line>"
            + "<Line>"
            + "<Name>Country Code</Name><Position>b27-36</Position><Value>366</Value></Line>"
            ...
            + "<Line>"
            + "<Name>US National Use</Name><Position>b76-83</Position><Value>01100001</Value></Line>";
    private static final String DECODE_15_CHRS_XML_STRING = "<?xml version=\"1.0\"?>"
            + "<Hexdecode>"
    ...
    private static final String DECODE_15_CHRS_HTML_STRING = "<html>" + "<head>"
            ...
            + "<TR><TD>US Model ID.</TD><TD>b64-67</TD><TD>0</TD></TR>"
            + "<TR><TD>US Run No.</TD><TD>b68-75</TD><TD>0</TD></TR>"
            + "<TR><TD>US National Use</TD><TD>b76-83</TD><TD>01100001</TD></TR>" + "</table>"
            + "<table>" + "</table>" + "</body>" + "</html>";
    private static final String DECODESEARCH_HTML_STRING = "<html>" + "<head>"
            + "<title>HEXDECODE of 406 Beacon</title>" + "</head>" + "<body>" + "<table>"
            + "<TR ALIGN=LEFT><TH>Item</TH><TH>Bits</TH><TH>Value</TH></TR>"
            + "<TR><TD>Hex Id</TD><TD>b26-85</TD><TD>ADCC40504000185</TD></TR>"
            + "<TR><TD>Serial Number</TD><TD>b44-63</TD><TD>5136</TD></TR>" + "</table>" + "<table>"
            + "</table>" + "</body>" + "</html>";
    ...
    public void testDecodeSearchWith15Chr() {
        assertEquals(DECODESEARCH_HTML_STRING,
                Hexdecode.decodeSearch(HEXSTRING_15_CHRS, "HTML").replace("\n", ""));

        assertEquals(DECODESEARCH_XML_STRING,
                Hexdecode.decodeSearch(HEXSTRING_15_CHRS, "XML").replace("\n", ""));

        assertEquals(DECODESEARCH_XML2_STRING,
                Hexdecode.decodeSearch(HEXSTRING_15_CHRS, "XML2").replace("\n", ""));

        assertEquals(DECODESEARCH_TEXT_STRING,
                Hexdecode.decodeSearch(HEXSTRING_15_CHRS, "TEXT").replace("\n", ""));
    }
    ...
    public void testDecodeSearchWith30Chr() {
        assertEquals(DECODESEARCH_HTML_STRING,
                Hexdecode.decodeSearch(HEXSTRING_30_CHRS, "HTML").replace("\n", ""));

        assertEquals(DECODESEARCH_XML_STRING,
                Hexdecode.decodeSearch(HEXSTRING_30_CHRS, "XML").replace("\n", ""));

        assertEquals(DECODESEARCH_XML2_STRING,
                Hexdecode.decodeSearch(HEXSTRING_30_CHRS, "XML2").replace("\n", ""));

        assertEquals(DECODESEARCH_TEXT_STRING,
                Hexdecode.decodeSearch(HEXSTRING_30_CHRS, "TEXT").replace("\n", ""));
    ...
    public void testDecodeWith15Chr() {
        assertEquals(DECODE_15_CHRS_HTML_STRING,
                Hexdecode.decode(HEXSTRING_15_CHRS, "HTML").replace("\n", ""));

        assertEquals(DECODE_15_CHRS_XML_STRING,
                Hexdecode.decode(HEXSTRING_15_CHRS, "XML").replace("\n", ""));

        assertEquals(DECODE_15_CHRS_XML2_STRING,
                Hexdecode.decode(HEXSTRING_15_CHRS, "XML2").replace("\n", ""));

        assertEquals(DECODE_15_CHRS_TEXT_STRING,
                Hexdecode.decode(HEXSTRING_15_CHRS, "TEXT").replace("\n", ""));
    ...
    public void testDecodeWith30Chr() {
        ...
        assertEquals(DECODE_30_CHRS_XML_STRING,
                Hexdecode.decode(HEXSTRING_30_CHRS, "XML").replace("\n", ""));

        assertEquals(DECODE_30_CHRS_XML2_STRING,
                Hexdecode.decode(HEXSTRING_30_CHRS, "XML2").replace("\n", ""));

        assertEquals(DECODE_30_CHRS_TEXT_STRING,
                Hexdecode.decode(HEXSTRING_30_CHRS, "TEXT").replace("\n", ""));

        assertEquals(DECODE_30_CHRS_HTML_STRING,
                Hexdecode.decode(HEXSTRING_30_CHRS, "HTML").replace("\n", ""));
    }
