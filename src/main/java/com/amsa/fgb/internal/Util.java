...
final class Util {
    ...
    public static List<HexAttribute> coarsePositionAttributes(double latSeconds, double lonSeconds, int s, int f) {
        ...
        list.add(new HexAttribute(AttributeType.COARSE_POSITION_LATITUDE, s, f, latSeconds / 3600.0 + "", ""));
        list.add(new HexAttribute(AttributeType.COARSE_POSITION_LONGITUDE, s, f, lonSeconds / 3600.0 + "", ""));
        return list;
    }
    ...
    public static List<HexAttribute> offsetPositionAttributes(double latDiffSeconds, double lonDiffSeconds, int s,
        ...
        list.add(
                new HexAttribute(AttributeType.OFFSET_POSITION_LONGITUDE_DIFF, s, f, lonDiffSeconds / 3600.0 + "", ""));
        return list;
    }
}
