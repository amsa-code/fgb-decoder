...
abstract class Conversions {
    ...
    static private Map hexMap;
    static private Map binMap;
    static private Map octMap;
    static private Map mbaudotToAsciiMap;
    static private Map asciiToMbaudotMap;
    static private Map aircraftMap;
    static private Map airRegMap;
	...
	hexMap = new HashMap();
       	...
       	hexMap.put("0100", new String("4"));
       	hexMap.put("0101", new String("5"));
       	hexMap.put("0110", new String("6"));
       	hexMap.put("0111", new String("7"));
       	hexMap.put("1000", new String("8"));
       	hexMap.put("1001", new String("9"));
       	hexMap.put("1010", new String("A"));
       	hexMap.put("1011", new String("B"));
       	hexMap.put("1100", new String("C"));
       	hexMap.put("1101", new String("D"));
       	hexMap.put("1110", new String("E"));
       	hexMap.put("1111", new String("F"));

	/* Make binMap from hexMap */
       	binMap = new HashMap();
	Iterator iter1 = hexMap.entrySet().iterator();
	while (iter1.hasNext()) {
	...
	aircraftMap = new HashMap();
       	aircraftMap.put("0", new String("A"));
       	aircraftMap.put("1", new String("B"));
       	aircraftMap.put("2", new String("C"));
       	aircraftMap.put("3", new String("D"));
       	aircraftMap.put("4", new String("E"));
       	aircraftMap.put("5", new String("F"));
       	aircraftMap.put("6", new String("G"));
       	aircraftMap.put("7", new String("H"));
       	aircraftMap.put("8", new String("I"));
       	aircraftMap.put("9", new String("J"));
       	aircraftMap.put("10", new String("K"));
       	aircraftMap.put("11", new String("L"));
       	aircraftMap.put("12", new String("M"));
       	aircraftMap.put("13", new String("N"));
       	aircraftMap.put("14", new String("O"));
       	aircraftMap.put("15", new String("P"));
       	aircraftMap.put("16", new String("Q"));
       	aircraftMap.put("17", new String("R"));
       	aircraftMap.put("18", new String("S"));
       	aircraftMap.put("19", new String("T"));
       	aircraftMap.put("20", new String("U"));
       	aircraftMap.put("21", new String("V"));
       	aircraftMap.put("22", new String("W"));
       	aircraftMap.put("23", new String("X"));
       	aircraftMap.put("24", new String("Y"));
       	aircraftMap.put("25", new String("Z"));
       	aircraftMap.put("26", new String("0"));
       	aircraftMap.put("27", new String("1"));
       	aircraftMap.put("28", new String("2"));
       	aircraftMap.put("29", new String("3"));
       	aircraftMap.put("30", new String("4"));
       	aircraftMap.put("31", new String("5"));
       	aircraftMap.put("32", new String("6"));
       	aircraftMap.put("33", new String("7"));
       	aircraftMap.put("34", new String("8"));
       	aircraftMap.put("35", new String("9"));

	mbaudotToAsciiMap = new HashMap();
        mbaudotToAsciiMap.put("56", new String("A"));
	mbaudotToAsciiMap.put("51", new String("B"));
        mbaudotToAsciiMap.put("46", new String("C"));
	mbaudotToAsciiMap.put("50", new String("D"));
	mbaudotToAsciiMap.put("48", new String("E"));
	mbaudotToAsciiMap.put("54", new String("F"));
	mbaudotToAsciiMap.put("43", new String("G"));
	mbaudotToAsciiMap.put("37", new String("H"));
	mbaudotToAsciiMap.put("44", new String("I"));
	mbaudotToAsciiMap.put("58", new String("J"));
	mbaudotToAsciiMap.put("62", new String("K"));
	mbaudotToAsciiMap.put("41", new String("L"));
	mbaudotToAsciiMap.put("39", new String("M"));
	mbaudotToAsciiMap.put("38", new String("N"));
	mbaudotToAsciiMap.put("35", new String("O"));
	mbaudotToAsciiMap.put("45", new String("P"));
	mbaudotToAsciiMap.put("61", new String("Q"));
	mbaudotToAsciiMap.put("42", new String("R"));
	mbaudotToAsciiMap.put("52", new String("S"));
	mbaudotToAsciiMap.put("33", new String("T"));
	mbaudotToAsciiMap.put("60", new String("U"));
	mbaudotToAsciiMap.put("47", new String("V"));
	mbaudotToAsciiMap.put("57", new String("W"));
	mbaudotToAsciiMap.put("55", new String("X"));
	mbaudotToAsciiMap.put("53", new String("Y"));
	mbaudotToAsciiMap.put("49", new String("Z"));
	mbaudotToAsciiMap.put("36", new String(" "));
	mbaudotToAsciiMap.put("24", new String("-"));
	mbaudotToAsciiMap.put("23", new String("/"));
	mbaudotToAsciiMap.put("13", new String("0"));
	mbaudotToAsciiMap.put("29", new String("1"));
	mbaudotToAsciiMap.put("25", new String("2"));
	mbaudotToAsciiMap.put("16", new String("3"));
	mbaudotToAsciiMap.put("10", new String("4"));
	mbaudotToAsciiMap.put("1",  new String("5"));
	mbaudotToAsciiMap.put("21", new String("6"));
	mbaudotToAsciiMap.put("28", new String("7"));
	mbaudotToAsciiMap.put("12", new String("8"));
	mbaudotToAsciiMap.put("3",  new String("9"));

	/* Make asciiToMbaudotMap from hexMap */
	asciiToMbaudotMap = new HashMap();
	Iterator iter2 = mbaudotToAsciiMap.entrySet().iterator();
	while (iter2.hasNext()) {
	...
	octMap = new HashMap();
       	octMap.put("000", new String("0"));
       	octMap.put("001", new String("1"));
       	octMap.put("010", new String("2"));
       	octMap.put("011", new String("3"));
       	octMap.put("100", new String("4"));
       	octMap.put("101", new String("5"));
       	octMap.put("110", new String("6"));
       	octMap.put("111", new String("7"));
	...
	/*
	// 14 July 2005
	// This doesn't work properly for boundary cases!
	double dec = origDec;
	int L1 = (int)(dec/1296);

	//System.out.println("L1=" + L1);
	
	dec = dec/1296.0 - (int)(dec/1296);
	int L2 = (int)(dec*36.0+0.000005);

	//System.out.println("L2=" + L2);

	dec = dec*36.0 - (int)(dec*36+0.000005);	
	// Add 0.000005 is for adjusting the loss precision of double value
	int L3 = (int)(dec*36.0+0.000005);
	...
	*/
    ...
    static public String[] mBaudotBits2mBaudotStr(String protocolName, String mbaudotBits, int bits) 
    {
	...
	for (int j=0; j<n; j++) 
	{
		...
		if (s.equals(" ")) 
			...
			mbaudotStr = mbaudotStr + "?";
			if (spaceCount==j && n!=1) 
			{   // n==1 && UserMaritime (or User RadioCallsign) means it is for Specidic Beacon Number (bit 76-81)
		    ...
		    else if (protocolName.equalsIgnoreCase("Aviation") || protocolName.equalsIgnoreCase("Maritime") || protocolName.equalsIgnoreCase("Orbitography"))
		    {
			// n==1 && UserMaritime (or User RadioCallsign) means it is for Specidic Beacon Number (bit 76-81)
			if (n == 1)
			{
		...
		{
		    // n==1 && UserMaritime (or User RadioCallsign) means it is for Specific Beacon Number (bit 76-81)
		    if (n==1 && (protocolName.equalsIgnoreCase("Maritime") || protocolName.equalsIgnoreCase("Radio Call Sign")))
		    {
			mbaudotStr = mbaudotStr + "?";
	...
	// Deal with SPACE if the protocol is not User Radion Call Sign, these protocols are: UserAviation, UserMaritime and UserSerialAircraftOperator
	...
	int countNum = 1;
	// 02/Nov/2005
	// If mbaudotStr is all "*", then they are all spaces, which is allowed in the Orbitography User protocol
