...
class Common {
    ...
    public static List<HexAttribute> maritimeEmergencyCodes(List<HexAttribute> result,
            String binCode) {
    ...
    public static List<HexAttribute> nonMaritimeEmergencyCodes(List<HexAttribute> result,
            String binCode) {
        String name = "Nature of Distress";
