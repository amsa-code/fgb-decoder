...
abstract class StandardLocationShipMMSIOrSecurityAlertSystemBase extends StandardLocation {

    private Consumer consumer;

    StandardLocationShipMMSIOrSecurityAlertSystemBase(String stdProtocolCode, String protocolName, Consumer consumer) {
    ...
    interface Consumer {
        void accept(StandardLocationShipMMSIOrSecurityAlertSystemBase s, String binCode, List<HexAttribute> result);
    }
